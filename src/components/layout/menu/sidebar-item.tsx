...
export const SidebarItem = ({
	...
	const classNames = clsx(
		"w-full hover:bg-ivory/8 p-1.5 flex flex-inline items-center gap-2 select-none rounded-md cursor-pointer text-ellipsis overflow-hidden whitespace-nowrap",
		active && "bg-ivory/10",
	);
